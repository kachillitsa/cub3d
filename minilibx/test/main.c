...
int	main()
{
  ...
  color_m_1(win1,WIN1_SX,WIN1_SY);
  printf("OK\n");
  sleep(2);
  ...
  data1 = mlx_get_data_addr(im1,&bpp1,&sl1,&b_ord1);
  printf("OK (bpp1: %d, sizeline1: %d b_ord: %d type: %d)\n",bpp1,sl1,b_ord1,
	 ((t_img *)im1)->type);

  printf(" => Fill Image1 ...");
  color_m_2(data1,bpp1,sl1,IM1_SX,IM1_SY,b_ord1, 1);
  printf("OK (pixmap : %d)\n",(int)((t_img *)im1)->pix);
  ...
  data3 = mlx_get_data_addr(im3,&bpp3,&sl3,&b_ord3);
  printf("OK (bpp3 %d, sizeline3 %d b_ord3 %d type %d)\n",bpp3,sl3,b_ord3,
	 ((t_img *)im3)->type);

  printf(" => Fill Image3 ...");
  color_m_2(data3,bpp3,sl3,IM3_SX,IM3_SY,b_ord3, 1);
  printf("OK (pixmap : %d)\n",(int)((t_img *)im3)->pix);
  ...
  data2 = mlx_get_data_addr(im2,&bpp2,&sl2,&b_ord2);
  printf("OK (xpm %dx%d)(img bpp2: %d, sizeline2: %d b_ord: %d type: %d)\n",
	 xpm1_x,xpm1_y,bpp2,sl2,b_ord2,((t_img *)im2)->type);
  sleep(2);
  ...
  data4 = mlx_get_data_addr(im4,&bpp4,&sl4,&b_ord4);
  color_m_2(data4,bpp4,sl4,IM3_SX,IM3_SY,b_ord4, 2);
...
int	color_m_1(void *win,int w,int h)
{
  int	x;
  int	y;
  int	color;
...
int	color_m_2(unsigned char *data,int bpp,int sl,int w,int h,int b_ord, int type)
{
  int	x;
  int	y;
  int	opp;
