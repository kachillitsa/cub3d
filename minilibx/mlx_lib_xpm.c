				     ...
				     int (*xpm_func)(),void *param)
{
  ...
  xpm_att.colormap = xvar->c_map;
  xpm_att.depth = xvar->depth;
  xpm_att.bitm_format = ZPixmap;
...
int	mlx_int_egal_img(XImage *img1,XImage *img2)
{
  if (img1->width!=img2->width || img1->height!=img2->height ||
      ...
      img1->bitm_unit!=img2->bitm_unit ||
      img1->bitm_bit_order!=img2->bitm_bit_order ||
      img1->bitm_pad!=img2->bitm_pad || img1->depth!=img2->depth ||
